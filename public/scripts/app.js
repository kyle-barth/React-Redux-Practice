...
var Traveler = function (_Person2) {
    ...
    _createClass(Traveler, [{
        ...
        value: function getGreeting() {
            ...
            if (this.hasLocation()) {
                greeting += ' I am travelling from ' + this.location + '.';
            }
            return greeting;
        }
    }]);
...
var me = new Student('Kyle Barth', 21, 'Computer Science');
console.log(me.getDescription());

var anon = new Student();
console.log(anon.getDescription());

var gary = new Traveler('Gary', 26);
console.log(gary.getGreeting());

var holidave = new Traveler('Holidave', 39, 'Paris');
console.log(holidave.getGreeting());
